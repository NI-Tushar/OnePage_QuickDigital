...
<section class="banner" style="display:none">
    ...
    <section class="bg_dim_color w-100 p-5">
        <div class="accordion dark-accordion bg_color container py-5" id="simpleaccordion">
            ...
            কেন আমাদের কাছ থেকে আপনি আপনার অনলাইন ব্যাবসার জন্য একটি ই-কমার্স ওয়েবসাইট কিনবেন? 
            কিংবা আপনার ব্যাবসার প্রসার কিংবা অধিক লাভের জন্য একটি ই-কমার্স ওয়েবসাইট কেন দরকার?
            </h4>
            <!-- Section 1 -->
